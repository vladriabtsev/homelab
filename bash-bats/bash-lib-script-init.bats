...
@test "./script-1.sh 1" {
  ...
  assert_output --partial ' - file: ./script-1.sh, line: 11, func: main, command: unknown-command'
}
@test "./script-1.sh 2" {
  # https://bats-core.readthedocs.io/en/stable/writing-tests.html
  bats_require_minimum_version 1.5.0
  ...
  assert_output --partial 'source trace:'
  assert_output --partial ' - file: ./script-2.sh, line: 11, func: main, command: unknown-command'

  assert_output --partial 'script ./script-1.sh exited with error code: 127'
  assert_output --partial 'error trace ./script-1.sh:'
  assert_output --partial '>>>./script-2.sh $1'
  assert_output --partial ' - file: ./script-1.sh, line: 12, func: main, command: ./script-2.sh $1'
}
@test "./script-1.sh 3" {
  # https://bats-core.readthedocs.io/en/stable/writing-tests.html
  bats_require_minimum_version 1.5.0
  ...
  assert_output --partial 'source trace:'
  assert_output --partial ' - file: ./script-3.sh, line: 11, func: main, command: unknown-command'

  assert_output --partial 'script ./script-2.sh exited with error code: 127'
  assert_output --partial 'error trace ./script-2.sh:'
  assert_output --partial '>>>./script-3.sh $1'
  assert_output --partial ' - file: ./script-2.sh, line: 12, func: main, command: ./script-3.sh $1'
...
@test "./script-lib.sh 1" {
  ...
  assert_output --partial '>>>  [[ "$1" == "1" ]] && unknown-command'
  assert_output --partial 'source trace:'
  assert_output --partial ' - file: ./script-lib-1.bash, line: 8, func: script-1-exec, command: unknown-command'
  assert_output --partial ' - file: ./script-lib.sh, line: 15, func: main, command: script-1-exec'
}
@test "./script-lib.sh 2" {
  ...
  assert_output --partial '>>>  [[ "$1" == "2" ]] && unknown-command'
  assert_output --partial 'source trace:'
  assert_output --partial ' - file: ./script-lib-2.bash, line: 8, func: script-2-exec, command: unknown-command'
  assert_output --partial ' - file: ./script-lib-1.bash, line: 9, func: script-1-exec, command: script-2-exec'
  assert_output --partial ' - file: ./script-lib.sh, line: 15, func: main, command: script-1-exec'
}
@test "./script-lib.sh 3" {
  ...
  assert_output --partial ' - file: ./script-lib-2.bash, line: 9, func: script-2-exec, command: script-3-exec'
  assert_output --partial ' - file: ./script-lib-1.bash, line: 9, func: script-1-exec, command: script-2-exec'
  assert_output --partial ' - file: ./script-lib.sh, line: 15, func: main, command: script-1-exec'
}

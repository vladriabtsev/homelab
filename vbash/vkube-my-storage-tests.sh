...
./vkube --cluster-plan k3s-HA k3s storage-speed local-path office-csi-driver-smb-del office-synology-csi-smb-del office-synology-csi-nfs-del longhorn-nvme-del longhorn-ssd-del
